var RadiClass = Class.create( {
	...
	deleteEvervaleFile: function( id ) {
		...
		new Ajax.Request( 'ajax', {
							...
							method: 'post',
							parameters: {mode: 'deleteEvervaleFile', id: id}
	...
	deletePoll: function( id ) {
		...
		new Ajax.Request( 'ajax', {
							...
							method: 'post',
							parameters: {mode: 'deletePoll', id: id}
	...
	deleteFile: function( id ) {
		...
		Effect.Pulsate( elm, {duration: 2, pulses: 2} );
		Effect.Fade( elm, {delay: 1, duration: 0.5} );

		new Ajax.Request( 'ajax', {

							method: 'post',
							parameters: {mode: 'deleteFile', id: id}

		} );
		
	},
	
	forceLogout: function( id ) {
		...
		new Ajax.Request( 'ajax', {
							...
							method: 'post',
							parameters: {mode: 'forceLogout', id: id}
	...
	deleteForum: function( id ) {
		...
		new Ajax.Request( 'ajax', {
							...
							method: 'post',
							parameters: {mode: 'deleteForum', id: id}
	...
	getUsersOnline: function() {
		new Ajax.PeriodicalUpdater('online_users', 'ajax', {
			method: 'post',
			frequency: 3,
			decay: 2,
			parameters: {mode: 'getUsersOnline'}
		});
	}
